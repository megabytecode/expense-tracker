...
function buildOtpEmailText(otp: string) {
  return [
    ...
    'La persona usuaria comienza creando sus cuentas, que representan donde esta su dinero. Puede crear cuentas normales para uso diario, como efectivo, banco o billetera, y tambien cuentas de ahorro. La diferencia principal es que una cuenta normal se usa para registrar movimientos financieros habituales, como ingresos, gastos, transferencias y ajustes. En cambio, una cuenta de ahorro se usa para separar dinero destinado a ahorro y llevar un control mas claro de ese saldo.',
    '',
    '2. Registro de movimientos diarios',
    'Cuando la persona recibe dinero, registra un ingreso. Cuando gasta, registra un gasto. Si mueve dinero entre sus propias cuentas, registra una transferencia (un movimiento entre sus cuentas que no cuenta como gasto ni ingreso, y sirve tambien como tracking para aquellos que declaran renta y mueven mucho dinero entre cuentas). Cada movimiento puede incluir descripcion, monto, fecha, categoria y, si hace falta, distribucion entre varias cuentas. Esto permite que el dinero quede correctamente ubicado.',
    '',
    '3. Manejo de ahorros',
    'Los ahorros se organizan usando las cuentas de tipo ahorro. Los objetivos de ahorro son organizativos: ayudan a dar seguimiento al proposito del dinero, pero no crean transacciones financieras por si solos. El dinero real sigue viviendo dentro de las cuentas de ahorro. Para abonarle a un ahorro, la persona normalmente mueve dinero hacia una cuenta de ahorro, por ejemplo mediante una transferencia desde una cuenta normal.',
    '',
    '4. Manejo de deudas',
    'Las deudas no se llevan como un sistema separado del flujo financiero diario, pero permiten tener un listado de las mismas para que, de la mano de la herramienta de ahorro, se hagan presupuestos. Cuando la persona paga una deuda, registra ese pago como un gasto, usando la categoria correspondiente. Asi el pago impacta correctamente sus movimientos, sus cuentas y su historial.',
    '',
    '5. Revision y control',
    'Desde el historial de movimientos, la persona usuaria puede revisar, editar y corregir registros. Mientras mas constante sea al registrar ingresos, gastos, ahorros, transferencias y pagos de deuda, mayor claridad tendra sobre su situacion financiera.',
  ].join('\n');
}
          ...
          <div style="max-width:720px;margin:0 auto;background:#0f1c2e;border:1px solid rgba(148,163,184,.18);border-radius:28px;overflow:hidden;box-shadow:0 24px 80px rgba(0,0,0,.32);">
            <div style="padding:32px 28px 24px;border-bottom:1px solid rgba(148,163,184,.12);background:linear-gradient(180deg,rgba(20,184,166,.12) 0%,rgba(15,23,42,0) 100%);">
              ...
              <p style="margin:0;font-size:15px;line-height:1.7;color:#cbd5e1;">
                La persona usuaria solicito un codigo OTP para ingresar a su cuenta. Este codigo es personal y vence en <strong style="color:#f8fafc;">10 minutos</strong>.
              </p>
            </div>
            ...
            <div style="padding:28px;">
              <div style="margin-bottom:24px;border-radius:24px;background:linear-gradient(135deg,rgba(37,99,235,.16),rgba(20,184,166,.12));border:1px solid rgba(96,165,250,.18);padding:22px;">
                ...
                <p style="margin:14px 0 0;font-size:14px;line-height:1.6;color:#bfdbfe;">
                  Si la persona usuaria no solicito este acceso, puede ignorar este correo.
                </p>
              </div>
              ...
              <div style="margin-bottom:24px;border-radius:22px;background:#111f34;border:1px solid rgba(148,163,184,.14);padding:22px;">
                ...
                <p style="margin:0;font-size:14px;line-height:1.7;color:#cbd5e1;">
                  Un resumen rapido para entender como registrar y organizar sus finanzas dentro de la aplicacion.
                </p>
              </div>
              ...
              <div style="display:grid;gap:14px;">
                <div style="border-radius:20px;background:#0b1728;border:1px solid rgba(148,163,184,.12);padding:18px;">
                  ...
                  <p style="margin:0;font-size:14px;line-height:1.75;color:#d7e0ea;">
                    La persona usuaria comienza creando sus cuentas, que representan dónde está su dinero. Puede crear cuentas normales para uso diario, como efectivo, banco o billetera, y también cuentas de ahorro. La diferencia principal es que una cuenta normal se usa para registrar movimientos financieros habituales, como ingresos, gastos, transferencias y ajustes. En cambio, una cuenta de ahorro se usa para separar dinero destinado a ahorro y llevar un control más claro de ese saldo.
                  </p>
                </div>
                ...
                <div style="border-radius:20px;background:#0b1728;border:1px solid rgba(148,163,184,.12);padding:18px;">
                  ...
                  <p style="margin:0;font-size:14px;line-height:1.75;color:#d7e0ea;">
                    Los ahorros se organizan usando las cuentas de tipo ahorro. Los objetivos de ahorro son organizativos: ayudan a dar seguimiento al propósito del dinero, pero no crean transacciones financieras por sí solos. El dinero real sigue viviendo dentro de las cuentas de ahorro. Para abonarle a un ahorro, la persona normalmente mueve dinero hacia una cuenta de ahorro, por ejemplo mediante una transferencia desde una cuenta normal.
                  </p>
                </div>
                ...
                <div style="border-radius:20px;background:#0b1728;border:1px solid rgba(148,163,184,.12);padding:18px;">
                  ...
                  <p style="margin:0;font-size:14px;line-height:1.75;color:#d7e0ea;">
                    Desde el historial de movimientos, la persona usuaria puede revisar, editar y corregir registros. Mientras más constante sea al registrar ingresos, gastos, ahorros, transferencias y pagos de deuda, mayor claridad tendrá sobre su situación financiera.
                  </p>
                </div>
              </div>
            </div>
